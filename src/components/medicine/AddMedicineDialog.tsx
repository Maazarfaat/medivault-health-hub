...
export function AddMedicineDialog({ open, onOpenChange, onAdded, defaultMethod = 'manual' }: AddMedicineDialogProps) {
  ...
  const handleQrScan = (data: Record<string, string>) => {
    setForm((f) => ({
      ...
      manufacturingDate: data.manufacturingDate || f.manufacturingDate,
    ...
    >
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Scan QR code or add medicine details manually.</DialogDescription>
        </DialogHeader>
