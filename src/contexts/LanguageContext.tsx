...
const translations: Record<Language, LanguageLabels> = {
  ...
  ur: {
    ...
    locationRequested: 'مقام کی اجازت', locationDenied: 'مقام کی اجازت نہیں دی گئی۔', restockSent: 'ری اسٹاک درخواست بھیجی', restockDesc: 'قریبی فارمیسیوں کو بھیجی گئی۔', requestFor: 'درخواست', openMap: 'نقشے میں کھولیں', noLocation: 'مقام نہیں', location: 'مقام', saveLocation: 'میرا مقام محفوظ کریں', locationSaved: 'مقام محفوظ ہو گیا',
